...
<div id="node-<?php print $node->nid; ?>"
     class="<?php print $classes; ?> clearfix node-event-teaser"<?php print $attributes; ?>>
  ...
  <div class="row">
    ...
    <div class="col-md-1">
      <div class="field_date">
        <span><?php print date('d', $node->field_event_date['und'][0]['value']) ?></span>
        <span><?php print date('M', $node->field_event_date['und'][0]['value']) ?></span>
      </div>
    </div>
    <div class="col-md-9 field_content"><h2<?php print $title_attributes; ?>><?php print $title; ?></h2>
